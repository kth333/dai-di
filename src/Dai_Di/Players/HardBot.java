<<<<<<< Updated upstream:src/Dai_Di/Players/HardBot.java
...
=======
package src;
>>>>>>> Stashed changes:src/HardBot.java
...
public class HardBot extends Bot {
    ...
    public PlayResult play(PlayedCards previousCards, int consecutivePasses) {
        ...
        List<Card> botHand = super.getHand().getCardsInHand();
        ...
        if (validCombinations != null) {
            ...
            for (PlayedCards combination : validCombinations) {
                ...
                if (previousCards == null || combination.winsAgainst(previousCards)) {
                    ...
                    System.out.println("\n" + super.getName() + " played: " + combination);
        ...
        System.out.println("\n" + super.getName() + " passed their turn.");
        consecutivePasses++;
        return new PlayResult(this,previousCards, consecutivePasses);
    }
